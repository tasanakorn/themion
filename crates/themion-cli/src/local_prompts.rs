...
pub fn is_peer_message_prompt(prompt: &str) -> bool {
    prompt
        .lines()
        .take(32)
        .any(|line| line.starts_with(PEER_MESSAGE_PREFIX))
}
