...
| PRD-107 | [Queued Delivery for Stylos Talk](prd/prd-107-queued-delivery-for-stylos-talk.md) | Implemented | v0.66.0 | `themion-cli`, `themion-core`, docs; removes the non-idle talk rejection guard so valid known-target talk delivers now or queues, with `queue_full` as the normal post-validation rejection |
