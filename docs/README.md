...
| PRD-029 | [Stylos Notes Board Phase 1 — Replace Ephemeral Talk with Durable Note Intake and Board Sections](prd/prd-029-stylos-notes-board-phase-1.md) | Proposed | v0.16.0 | `themion-core`, `themion-cli`, docs |
