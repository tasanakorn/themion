...
| PRD-024 | [Client-Side Git Repo Identity Normalization for Stylos Agent Git Queries](prd/archive/prd-024-client-side-git-repo-identity-normalization-for-stylos-agent-git-queries.md) | Implemented   | v0.13.1 | `themion-cli`, docs |
